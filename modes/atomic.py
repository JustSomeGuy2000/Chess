...
info=Info("Atomic Chess","The nuclear age begins.",lore,join(PCS_IMG_DIR,"king_b.png"),GREEN_TILE,"mode",[s.pawn_info,s.bishop_info,s.knight_info,s.rook_info,s.queen_info,s.king_info],internal_name="atomic")
info.construct()

def after_capture(game:Game, final_tile:Tile):
